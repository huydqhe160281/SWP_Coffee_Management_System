<%-- 
    Document   : createNewSize
    Created on : 25-06-2024, 00:10:50
    Author     : Dinh Hai
--%>
...
<html>
<head>
    <title>Size Management System</title>
    <meta charset="utf-8" />
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="/sizes">Size Management</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="/size_create">Create New Size</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            <div class="card-block w-75 m-auto">
                                                <h3 class="text-center m-auto pb-5">Create New Size</h3>
                                                <% if (request.getAttribute("error") != null) { %>
                                                <div class="alert alert-danger">
                                                    <%= request.getAttribute("error") %>
                                                </div>
                                                <% } %>
                                                <form class="form-material" action="size_create" method="post">
