...
<!--                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right pt-3">
                                                                            <button class="btn btn-primary btn-sm" onclick="window.location.href = '/ingredient_detail?ingredientID=${c.categoryID}'">View</button>
                                                                            <button class="btn btn-warning btn-sm" onclick="window.location.href = '/ingredient_update?ingredientID=${c.categoryID}'">Edit</button>
                                                                        </td>
                                                                    </tr>-->
                                                                </c:forEach>
